...
class CheckoutPageComplete extends AbstractRequest implements OmnipayResponseInterface
{
     ...
     * CHECKME: The orderNumber may actually be what we need, as that is used when cpaturing
     * authorised payments. The documentation inplies the orderNumber is generated by the
     * merchant site for the request, while the examples deomonsrate it being returned by
     * the gateway. It's not clear which is true.
     */
